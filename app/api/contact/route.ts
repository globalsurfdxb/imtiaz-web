...
export async function POST(req: NextRequest) {
  ...
  const payload = {
    ...
    Medium__c:                    "",
    Platform_Source__c:           "",
    Preferred_mode_of_contact__c: "",
    Ad_Name__c:                   data.utm_adid           || "",
    Campaign_Name__c:             "Book a Viewing Campaign",
  ...
  console.log("Salesforce contact payload:", payload);
  ...
  try {
    ...
    if (!sfRes.ok) {
      console.error("Salesforce contact error:", sfRes.status, sfData);
    }
