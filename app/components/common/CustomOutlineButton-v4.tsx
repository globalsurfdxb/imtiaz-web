...
const CustomOutlineButton = ({
  ...
  return (
    <button
      ...
      className={`cursor-pointer flex items-center justify-center group relative transition-all duration-300 overflow-hidden ${px} py-[14px] lg:py-4 2xl:py-[19px] 3xl:py-[20.62px] max-md:h-[36px] max-md:py-0 max-md:px-[19px] rounded-full border ${borderColor} ${textColor} font-[avenirBook] leading-[100%] ${className} ${readMore ? "text-[12px] md:text-[16px]" : "text-[12px] md:text-[16px] md:text-[19px]" }`}
