...
import MessageSection from "./sections/MessageSection-v4";
import VisionSection from "./sections/VisionSection-v4";
import Philosophy from "./sections/Philosophy-v4";
import HistorySection from "./sections/HistorySlider-v4";
import AwardSection from "./sections/Award-v4";
import Expertise from "./sections/Expertise-v4";
import OtherPageSlider from "./sections/OtherPageSlider-v4";
  ...
  return (
    <>
      <InnerHeroBanner
        ...
        maxW="max-w-[904px]"
      />
      {data?.show_vision_section == "true" && (
        <VisionSection data={visionSectionData} />
      )}
      {data?.show_chairman_section == "true" && (
        <MessageSection data={chairmanMessageData} />
      )}
      {data?.show_ceo_section == "true" && (
        <MessageSection data={ceoMessageData} />
      )}
      {data?.show_philosophy_section == "true" && (
        <Philosophy
          title={data.philosophy_title}
          description={data.philosophy_caption}
        />
      )}
      {data?.show_history_section == "true" && (
        <HistorySection
