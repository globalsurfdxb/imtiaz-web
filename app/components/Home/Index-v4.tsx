...
import ProSliderComingSoonV3 from "../../components/Home/sections/ProSliderComingSoonV3-v4";
import FpfSection from "../../components/Home/sections/FpfSection-v4";
import ProSliderV3 from "../../components/Home/sections/ProsliderV3-v4";
// import ImtiazProperties from "../../components/Home/sections/ImtiazPropsSlider";
import ConstructionProgress2 from "../../components/Home/sections/ConstructionProgress2-v4";
import AppSectionV2 from "../../components/Home/sections/AppSection-v4";
import CommunityNamesSlider from "../../components/Home/sections/CommunityNamesSlider-v4";
import AboutJourneyV3 from "../../components/Home/sections/AboutJourneyV3-v4";
import SpotlightSlider from "../../components/Home/sections/SpotlightSlider-v4";
import HeroSection from "./sections/HeroSection-v4";
import { HomePageResponse } from "./data";
import ImtiazPropertiesSnap from "./sections/ImtiazPropertiesSnap-v4";
import SpotlightSliderSnap from "./sections/SpotlightSliderSnap-v4";
